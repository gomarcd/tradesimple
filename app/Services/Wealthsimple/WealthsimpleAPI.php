...
'FetchIdentityPositions' => "query FetchIdentityPositions(
    ...
    \$includeAccountData: Boolean = false,
    \$includeOneDayReturnsBaseline: Boolean = false,
    \$includeQuoteV2: Boolean = false
) {
    identity(id: \$identityId) {
        id
...
fragment SecuritySummary on Security {
    ...
    quote @skip(if: \$includeQuoteV2) {
        ...QuoteSummary
        __typename
    }
    quoteV2 @include(if: \$includeQuoteV2) {
        ...QuoteV2Summary
        __typename
    }
    stock {
...
fragment QuoteV2Summary on UnifiedQuote {
    previousBaseline
    price
    currency
    quotedAsOf
...
fragment UnderlyingSecuritySummary on Security {
    ...
    public function getPositions(string $currency, ?array $accountIds = null, int $first = 100, ?string $cursor = null): array
    {
        $identityId = $this->getTokenInfo()->identity_canonical_id;
