...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => ''.e(__('Update password')).'','subheading' => ''.e(__('Ensure your account is using a long, random password to stay secure')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => ''.e(__('Update password')).'','subheading' => ''.e(__('Ensure your account is using a long, random password to stay secure')).'']); ?>
...
<?php endif; ?>
</section><?php /**PATH /Users/md/dev/tradesimple/resources/views/livewire/settings/password.blade.php ENDPATH**/ ?>