...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => ''.e(__('Profile')).'','subheading' => ''.e(__('Update your name and email address')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => ''.e(__('Profile')).'','subheading' => ''.e(__('Update your name and email address')).'']); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2433807279-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
</section><?php /**PATH /Users/md/dev/tradesimple/resources/views/livewire/settings/profile.blade.php ENDPATH**/ ?>