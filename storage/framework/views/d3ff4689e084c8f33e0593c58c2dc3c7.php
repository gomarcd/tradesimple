...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => ''.e(__('Appearance')).'','subheading' => ''.e(__('Update the appearance settings for your account')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => ''.e(__('Appearance')).'','subheading' => ''.e(__('Update the appearance settings for your account')).'']); ?>
...
<?php endif; ?>
</div><?php /**PATH /Users/md/dev/tradesimple/resources/views/livewire/settings/appearance.blade.php ENDPATH**/ ?>